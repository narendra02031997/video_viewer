...
class VideoViewer extends StatefulWidget {
  ...
  // The fuction returns the context of this video viewer
  
  final Function(BuildContext buildContext) getContext;
...
class VideoViewerState extends State<VideoViewer> {
  ...
  void initState() {
    ...
    isExternalConnected=widget.externalConnected;
    print("INITIALIZING");
    _initVideoViewer();
    super.initState();
  }
  ...
  //  print("INSIDE VIDEO_VIEWER WIDGET");
    return _initialized
        ? MultiProvider(
            providers: [
            ...
            builder: (_, child) {
              ...
              widget.getContext(_);
              return  VideoViewerCore(externalConnected:widget.externalConnected);
            },
          )
        : AspectRatio(
